...
\begin{figure}[H]
\centering
\includegraphics[scale=0.22]{trust_plot_trefoil}
\includegraphics[scale=0.28]{best_rep_trefoil}
\includegraphics[scale=0.39]{optimal_perp_trefoil}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.22]{trust_plot_mammoth}
\includegraphics[scale=0.28]{best_rep_mammoth}
\includegraphics[scale=0.39]{optimal_perp_mammoth}
