...
for (j in 1:b) {
  X_tsne = Rtsne(Z, perplexity = 65)$Y
  X_tsne_noise = Rtsne(Z, perplexity = 45)$Y
...
# save(best_X, best_X_noise, best_trust, best_trust_noise, file = "best rep (8 dim CyTOF).Rda")
save(Z, best_X, best_X_noise, best_trust, best_trust_noise, file = "~/DR noise/Output/best rep (8 dim CyTOF).Rda")