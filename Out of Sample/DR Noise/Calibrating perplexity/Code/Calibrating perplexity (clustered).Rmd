...
Y = rbind(mvrnorm(n/4, c(14,0,0,0,0,0), diag(15, nrow = r)),
          mvrnorm(n/4, c(0,16,0,0,0,0), diag(15, nrow = r)),
          mvrnorm(n/4, c(0,0,0,18,0,0), diag(15, nrow = r)),
          mvrnorm(n/4, c(0,0,0,0,15,0), diag(15, nrow = r)))
```
