...
for (j in 1:b) {
  X_tsne = Rtsne(Z, perplexity = 90)$Y
...
# save(best_X, best_X_noise, best_trust, best_trust_noise, file = "best rep (5 dim enterotype).Rda")
save(best_X, best_X_noise, best_trust, best_trust_noise, file = "~/DR noise/Output/best rep (5 dim enterotype).Rda")