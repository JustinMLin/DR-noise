...
for (j in 1:b) {
  X_tsne = Rtsne(Z, perplexity = 120)$Y
  X_tsne_noise = Rtsne(Z, perplexity = 40)$Y
...
# save(best_X, best_X_noise, best_trust, best_trust_noise, file = "best rep (5 dim scRNA-seq).Rda")
save(best_X, best_X_noise, best_trust, best_trust_noise, file = "~/DR noise/Output/best rep (5 dim scRNA-seq).Rda")