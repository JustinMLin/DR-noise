...
Y = rbind(mvrnorm(n=30, mu=runif(n=10, min=-10, max=10), Sigma=diag(abs(rnorm(n=10, mean=0, sd=10)))),
          mvrnorm(n=20, mu=runif(n=10, min=-10, max=10), Sigma=diag(abs(rnorm(n=10, mean=0, sd=10)))),
          mvrnorm(n=50, mu=runif(n=10, min=-10, max=10), Sigma=diag(abs(rnorm(n=10, mean=0, sd=10)))),
          mvrnorm(n=40, mu=runif(n=10, min=-10, max=10), Sigma=diag(abs(rnorm(n=10, mean=0, sd=10)))),
          mvrnorm(n=25, mu=runif(n=10, min=-10, max=10), Sigma=diag(abs(rnorm(n=10, mean=0, sd=10)))),
          mvrnorm(n=30, mu=runif(n=10, min=-10, max=10), Sigma=diag(abs(rnorm(n=10, mean=0, sd=10)))),
          mvrnorm(n=15, mu=runif(n=10, min=-10, max=10), Sigma=diag(abs(rnorm(n=10, mean=0, sd=10)))))

Z = cbind(Y, matrix(0, ncol=50, nrow=210)) + mvrnorm(n=210, mu=rep(0,60), Sigma=diag(rep(3,60)))

###

pca = prcomp(Z, center = TRUE, scale. = TRUE, rank. = 30)
...
perplexity = seq(from = 5, to = 65, by = 5)
b = 20
k = 20
...
# save(Y, df, p1, p2, file = trust vs shep (high dim sim).Rda")
save(Y, df, p1, p2, file = "~/DR noise/Output/trust vs shep (high dim sim).Rda")
